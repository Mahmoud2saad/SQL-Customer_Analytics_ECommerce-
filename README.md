...
```
├── Data
│ ├── q1.csv                       # Data for customer segmentation analysis
│ ├── q2.csv                       # Data for cohort analysis
│ └── q3.csv                       # Data for retention/churn analysis
├── Notebooks
│ └── data_analysis_graphs.ipynb   # Jupyter notebook for visualizations and exploration
├── SQL
│ ├── q1_customer_segmentation.sql # SQL queries for customer segmentation
│ ├── q2_cohort_analysis.sql       # SQL queries for cohort analysis
│ ├── q3_retention_analysis.sql    # SQL queries for customer retention
│ └── cohort_view.sql              # Helper view for cohort calculations
└── images
│  ├── 1_customer_segementation.png   # Customer segmentation chart
│  ├── 2_cohort_analysis.png          # Cohort analysis chart
│  └── 3_customer_churn_cohort_year.png  # Customer churn chart
